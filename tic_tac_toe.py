...
btn1 = Button(master, text=" ", font='Arial 15 bold', bg='pink', fg='navy', height=5, width=8, cursor="plus",command=lambda: clickonbtn(btn1))
btn1.grid(row=3, column=0)
btn2 = Button(master, text=' ', font='Arial 15 bold', bg='pink', fg='navy', height=5, width=8, cursor="plus",command=lambda: clickonbtn(btn2))
btn2.grid(row=3, column=1)
btn3 = Button(master, text=' ',font='Arial 15 bold', bg='pink', fg='navy', height=5, width=8, cursor="plus",command=lambda: clickonbtn(btn3))
btn3.grid(row=3, column=2)
btn4 = Button(master, text=' ', font='Arial 15 bold', bg='pink', fg='navy', height=5, width=8, cursor="plus",command=lambda: clickonbtn(btn4))
btn4.grid(row=4, column=0)
btn5 = Button(master, text=' ', font='Arial 15 bold', bg='pink', fg='navy', height=5, width=8, cursor="plus",command=lambda: clickonbtn(btn5))
btn5.grid(row=4, column=1)
btn6 = Button(master, text=' ', font='Arial 15 bold', bg='pink', fg='navy', height=5, width=8, cursor="plus",command=lambda: clickonbtn(btn6))
btn6.grid(row=4, column=2)
btn7 = Button(master, text=' ', font='Arial 15 bold', bg='pink', fg='navy', height=5, width=8, cursor="plus",command=lambda: clickonbtn(btn7))
btn7.grid(row=5, column=0)
btn8 = Button(master, text=' ', font='Arial 15 bold', bg='pink', fg='navy', height=5, width=8, cursor="plus",command=lambda: clickonbtn(btn8))
btn8.grid(row=5, column=1)
btn9 = Button(master, text=' ', font='Arial 15 bold', bg='pink', fg='navy', height=5, width=8, cursor="plus",command=lambda: clickonbtn(btn9))
